...
#         # print("queryCharacters")
#         # print("queryIndices")
# # My approach: first will pop that character and will insert required. Then will see this character first fro and begenning how much of element is there store in a list . It will went upto the last element. then return it.   
# Query 1
#    ↓
...
#    ↓
# save answer     
#         # print(len('queryCharacters'))

#         # Convert string to list so we can change characters
#         # queryCharacters = "bcb"
#         # queryIndices [1,3,3]
#         # print("queryCharacters:",queryCharacters)
#         # print("queryIndices:",queryIndices)
#         # print("queryCharacters:", queryCharacters)
#         # print("queryIndices:", queryIndices)
#         # a = list(s)  # a:  ['b', 'a', 'b', 'a', 'c', 'c']
#         # print("a: ", a)
#         # ans = []
...
#         #     index = queryIndices[i]  # index:  1, index:  3, index:  3
#         #     print("index: ", index)
#         #     a[index] = queryCharacters[i]
...
#         #     if a[j] == a[j - 1]:
#         #         current += 1
#         #         print("same character -> current:", current)
#         #     else:
#         #         current = 1
#         #         print("different character -> current:", current)
...
# # a[j]: c
# # a[j-1]: c
# # same character -> current: 2
# # longest: 2

# # i: 1
# # index:  3
# # a after update: ['b', 'b', 'b', 'c', 'c', 'c']
